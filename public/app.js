...
(function () {
    ...
    function MainController($location, $window, $http, jwtHelper, $scope) {
        ...
        vm.attend = function (bar) {
            $http.put('/api/location/' + nar.name, { user: vm.user }).then(function (res) {
        ...
        vm.cancel = function (bar) {
            $http.put('/api/location/leave/' + bar.name, { user: vm.user }).then(function (res) {
                vm.findBars(bar.city);
            }, function (err) {
                console.log(err);
            });
    ...
    function LoginController($http, $location, $window) {
        ...
        //         $http.get('/auth/facebook').then(function (res) {
        //             console.log(res);
        //         }, function (err) {
        //             console.log(err);
        //         });
